...
echo "Skipping download — using existing LibriSpeech features"

# Extracting the data and the cluster 
# python3 preprocess/tidy_libri360_kaldi_data.py $1 $2
# rm -rf libri-360

echo "Using existing LibriSpeech data at: $1"
echo "Saving processed output to: $2"

# Extract features & cluster labels
python3 preprocess/tidy_libri360_kaldi_data.py $1 $2
